...
_G.packer_plugins = {
  ...
  ["cmp-vimtex"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/cmp-vimtex",
  ...
  ["copilot-cmp"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/david/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
    url = "https://github.com/zbirenbaum/copilot-cmp"
  },
  ["copilot.lua"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/copilot.lua",
